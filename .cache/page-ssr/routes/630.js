...
var capitalize = __webpack_require__(3967);
 ...
 */
const Portal = /*#__PURE__*/index_js_.forwardRef(function Portal(props, forwardedRef) {
  const {
    children,
    container,
    disablePortal = false
  ...
  const handleRef = (0,useForkRef/* default */.A)( /*#__PURE__*/index_js_.isValidElement(children) ? (0,getReactElementRef/* default */.A)(children) : null, forwardedRef);
  ...
  if (disablePortal) {
    if ( /*#__PURE__*/index_js_.isValidElement(children)) {
      ...
      return /*#__PURE__*/index_js_.cloneElement(children, newProps);
    }
...
var getScrollbarSize = __webpack_require__(3205);
...
/* harmony import */ var _mui_utils_getReactElementRef__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(7223);
...
// EXTERNAL MODULE: ./node_modules/@mui/material/Modal/Modal.js + 6 modules
...
var InputBase = __webpack_require__(2390);
// EXTERNAL MODULE: ./node_modules/@mui/material/styles/styled.js
var styled = __webpack_require__(1848);
// EXTERNAL MODULE: ./node_modules/@mui/material/styles/rootShouldForwardProp.js
var rootShouldForwardProp = __webpack_require__(9770);
...
const inputClasses = (0,esm_extends/* default */.A)({}, inputBaseClasses/* default */.A, (0,generateUtilityClasses/* default */.A)('MuiInput', ['root', 'underline', 'input']));
...
const InputInput = (0,styled/* default */.Ay)(InputBase/* InputBaseComponent */.f3, {
  name: 'MuiInput',
  slot: 'Input',
...
const filledInputClasses = (0,esm_extends/* default */.A)({}, inputBaseClasses/* default */.A, (0,generateUtilityClasses/* default */.A)('MuiFilledInput', ['root', 'underline', 'input']));
...
const TextareaAutosize = /*#__PURE__*/index_js_.forwardRef(function TextareaAutosize(props, forwardedRef) {
  ...
  const textareaRef = index_js_.useRef(null);
  const handleRef = (0,useForkRef/* default */.A)(forwardedRef, textareaRef);
  const heightRef = index_js_.useRef(null);
  const hiddenTextareaRef = index_js_.useRef(null);
  const calculateTextareaStyles = index_js_.useCallback(() => {
  ...
  const frameRef = index_js_.useRef(-1);
  (0,useEnhancedEffect/* default */.A)(() => {
...
*/
var aa=__webpack_require__(541),ca=__webpack_require__(9982);function p(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var da=new Set,ea={};function fa(a,b){ha(a,b);ha(a+"Capture",b)}
...
/* harmony import */ var _isHostComponent__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2197);
...
const outlinedInputClasses = (0,esm_extends/* default */.A)({}, inputBaseClasses/* default */.A, (0,generateUtilityClasses/* default */.A)('MuiOutlinedInput', ['root', 'notchedOutline', 'input']));
...
function isMuiElement(element, muiNames) {
  ...
  return /*#__PURE__*/index_js_.isValidElement(element) && muiNames.indexOf( // For server components `muiName` is avaialble in element.type._payload.value.muiName
...
/* harmony import */ var _useForkRef__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(1523);
/* harmony import */ var _appendOwnerState__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(2879);
/* harmony import */ var _mergeSlotProps__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2505);
/* harmony import */ var _resolveComponentProps__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6677);
'use client';
